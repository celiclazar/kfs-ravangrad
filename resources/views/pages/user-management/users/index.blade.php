    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white shadow overflow-hidden rounded-lg">
            <div class="flex px-4 py-5 sm:px-6">
                <h2 class="flex-1 text-lg font-medium text-gray-900">{{ strtoupper('List of Users') }}</h2>
                    ...
                    @foreach($users as $user)
                        <div class="flex px-4 py-5 sm:px-6">
                            ...
                            <div class="w-1/3 flex justify-end space-x-4">
                                <a href="{{ route('users.permissions.edit', $user->id) }}" class="text-center text-sm flex items-center">
                                    <img src="/icons/32/pencil_32.png" alt="Edit Icon" class="inline h-5 w-5 mr-1" />
                                </a>
                                <a href="{{ route('users.permissions.delete', $user->id) }}" class="text-center text-sm flex items-center">
